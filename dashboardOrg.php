...
<style>
	...
	main section{width:30%;max-height:520px; border:1px solid #cfcfcf;box-shadow:10px 10px 10px -5px #cfcfcf;min-height:200px;position:relative;padding:30px 30px 110px;margin:0 auto 30px;}
	...
	<div class="wrapper">
		...
		<div class="main_con">
			...
			<!-- End of Sub Navigation -->
				...
				<div class="contents">
					<section >
						<p><div></div><i class='fas fa-money-check-alt' style='color:#5da5da;'></i>
							<?php
						//======================== PAYOUTS ============================//	
								if($payout_php != 0)
