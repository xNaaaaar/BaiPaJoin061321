...
main section{width:30%; height:630px; border:1px solid #cfcfcf;box-shadow:10px 10px 10px -5px #cfcfcf;min-height:200px;position:relative;padding:30px 30px 110px;margin:0 auto 30px;}
    ...
    <div class="wrapper">
      ...
      <div class="main_con">
        ...
        <main>
          ...
          <div class="contents">
          <section>	
						<p><div></div><i class='fas fa-money-bill' style='color:#60bd68;'></i>
							<?php
                  ...
                  echo "<b> Active Adventures </b><br><i class='fas fa-tree' style='color:#F15854;'></i> ";
					...
					<section id='graph'>
					<h3 style="color:black"><i class='fas fa-chart-line' style='color:#60bd68'></i> Daily Sales Chart</h3><br><br><br>
